...
var Evented$1 = Ember.Evented;
var ArrayProxy$1 = Ember.ArrayProxy;
var set = Ember.set;
var get$2 = Ember.get;
...
/**
  ...
  @uses Ember.Evented
 */
var Errors = ArrayProxy$1.extend(Evented$1, {
  /**
  ...
  */
  ...
  /**
    ...
    @private
  */
  errorsByAttributeName: computed$1(function () {
  ...
  */
  _clear: function _clear() {
    ...
    ArrayProxy$1.prototype.clear.call(this);
  },
...
var relationshipsDescriptor = computed$2(function () {
...
var relatedTypesDescriptor = computed$2(function () {
  var _this = this;
...
var relationshipsByNameDescriptor = computed$2(function () {
  ...
  */
  ...
  _findInverseFor: function _findInverseFor(name, store) {
    ...
    if (options.inverse) {
      ...
      (true && !(!isNone(inverse)) && Ember.assert("We found no inverse relationships by the name of '" + inverseName + "' on the '" + inverseType.modelName + "' model. This is most likely due to a missing attribute on your model definition.", !isNone(inverse)));
...
var makeArray$1 = Ember.makeArray;
var isPresent$1 = Ember.isPresent;
...
function AdapterError(errors) {
  ...
  EmberError$2.call(this, message);
...
AdapterError.prototype = Object.create(EmberError$2.prototype);
...
function errorsHashToArray(errors) {
  ...
  if (isPresent$1(errors)) {
    Object.keys(errors).forEach(function (key) {
      var messages = makeArray$1(errors[key]);
...
var Evented$2 = Ember.Evented;
var MutableArray = Ember.MutableArray;
var EmberObject$1 = Ember.Object;
var get$5 = Ember.get;
...
*/
var ManyArray = EmberObject$1.extend(MutableArray, Evented$2, {
  init: function init() {
    this._super.apply(this, arguments);
...
var copy$2 = Ember.copy;
var inspect$3 = Ember.inspect;
var EmberError$4 = Ember.Error;
var get$7 = Ember.get;
...
var Snapshot = function () {
  ...
  Snapshot.prototype.attr = function attr(keyName) {
    ...
    throw new EmberError$4("Model '" + inspect$3(this.record) + "' has no attribute named '" + keyName + "' defined.");
  };
  ...
  Snapshot.prototype.attributes = function attributes() {
    return copy$2(this._attributes);
  };
  ...
  Snapshot.prototype.changedAttributes = function changedAttributes() {
    ...
    for (var i = 0, length = changedAttributeKeys.length; i < length; i++) {
      ...
      changedAttributes[key] = copy$2(this._changedAttributes[key]);
    }
  ...
  Snapshot.prototype.belongsTo = function belongsTo(keyName, options) {
    ...
    if (!(relationship && relationship.relationshipMeta.kind === 'belongsTo')) {
      throw new EmberError$4("Model '" + inspect$3(this.record) + "' has no belongsTo relationship named '" + keyName + "' defined.");
    }
  ...
  Snapshot.prototype.hasMany = function hasMany(keyName, options) {
    ...
    if (!(relationship && relationship.relationshipMeta.kind === 'hasMany')) {
      throw new EmberError$4("Model '" + inspect$3(this.record) + "' has no hasMany relationship named '" + keyName + "' defined.");
    }
...
var resolve$1 = Ember.RSVP.resolve;
...
BelongsToReference.prototype.push = function (objectOrPromise) {
  ...
  return resolve$1(objectOrPromise).then(function (data) {
    var record = void 0;
...
var A$3 = Ember.A;
var resolve$2 = Ember.RSVP.resolve;
var get$9 = Ember.get;
...
HasManyReference.prototype.push = function (objectOrPromise) {
  ...
  return resolve$2(objectOrPromise).then(function (payload) {
    var array = payload;
    ...
    if (useLegacyArrayPush) {
      ...
      internalModels = A$3(records).mapBy('_internalModel');
...
HasManyReference.prototype.load = function () {
  ...
  return resolve$2(this.hasManyRelationship.manyArray);
};
...
var EmberError$3 = Ember.Error;
var isEqual = Ember.isEqual;
var isEmpty$1 = Ember.isEmpty;
var setOwner$1 = Ember.setOwner;
var run = Ember.run;
...
var InternalModel = function () {
  ...
  InternalModel.prototype.getRecord = function getRecord(properties) {
    if (!this._record && !this._isDematerializing) {
      ...
      if (setOwner$1) {
        ...
        setOwner$1(createOptions, getOwner(this.store));
      } else {
  ...
  */
  ...
  InternalModel.prototype.changedAttributes = function changedAttributes() {
    ...
    var newData = emberAssign(copy$1(inFlightData), currentData);
  ...
  */
  ...
  InternalModel.prototype._unhandledEvent = function _unhandledEvent(state, name, context) {
    ...
    throw new EmberError$3(errorMessage);
  };
...
function normalizeResponseHelper(serializer, store, modelClass, payload, id, requestType) {
  ...
  (true && !(isEmpty$2(validationErrors)) && Ember.assert('normalizeResponse must return a valid JSON API document:\n\t* ' + validationErrors.join('\n\t* '), isEmpty$2(validationErrors)));
...
function _findMany(adapter, store, modelName, ids, internalModels) {
  var snapshots = A$4(internalModels).invoke('createSnapshot');
...
var Evented$3 = Ember.Evented;
var ArrayProxy$2 = Ember.ArrayProxy;
var set$4 = Ember.set;
var get$11 = Ember.get;
var computed$4 = Ember.computed;
...
var RecordArray = ArrayProxy$2.extend(Evented$3, {
  init: function init() {
    this._super.apply(this, arguments);
  ...
  /**
   ...
   @type DS.Model
   */
  type: computed$4('modelName', function () {
    if (!this.modelName) {
      return null;
    }
...
var FilteredRecordArray = RecordArray.extend({
  ...
  */
  ...
  updateFilter: observer$1('filterFunction', function () {
...
var AdapterPopulatedRecordArray = RecordArray.extend({
  init: function init() {
    ...
    this.set('content', this.get('content') || A$6());
...
var set$1 = Ember.set;
var get$3 = Ember.get;
var computed$3 = Ember.computed;
var RSVP = Ember.RSVP;
var Service = Ember.Service;
var typeOf = Ember.typeOf;
var isPresent = Ember.isPresent;
var isNone$1 = Ember.isNone;
...
Store = Service.extend({
  ...
  */
  ...
  /**
    ...
    @return DS.Adapter
  */
  defaultAdapter: computed$3('adapter', function () {
  ...
  */
  findByIds: function findByIds(modelName, ids) {
    ...
    return promiseArray(RSVP.all(promises).then(A$2, null, 'DS: Store#findByIds of ' + normalizedModelName + ' complete'));
  },
  ...
  */
  peekRecord: function peekRecord(modelName, id) {
    ...
    (true && !(isPresent(modelName) && isPresent(id)) && Ember.assert('You need to pass both a model name and id to the store\'s peekRecord method', isPresent(modelName) && isPresent(id)));
    (true && !(typeof modelName === 'string') && Ember.assert('Passing classes to store methods has been removed. Please pass a dasherized string instead of ' + modelName, typeof modelName === 'string'));
  ...
  */
  updateId: function updateId(internalModel, data) {
    ...
    (true && !(isNone$1(existingInternalModel) || existingInternalModel === internalModel) && Ember.assert('\'' + modelName + '\' was saved to the server, but the response returned the new id \'' + id + '\', which has already been used with another record.\'', isNone$1(existingInternalModel) || existingInternalModel === internalModel));
  ...
  */
  ...
  _modelFactoryFor: function _modelFactoryFor(modelName) {
    ...
    if (!factory) {
      ...
      if (!factory) {
        throw new EmberError$1('No model was found for \'' + modelName + '\'');
      }
  ...
  */
  ...
  _pushResourceIdentifier: function _pushResourceIdentifier(relationship, resourceIdentifier) {
    if (isNone$1(resourceIdentifier)) {
      return;
    }
  ...
  _pushResourceIdentifiers: function _pushResourceIdentifiers(relationship, resourceIdentifiers) {
    if (isNone$1(resourceIdentifiers)) {
      return;
    }
...
var computed$5 = Ember.computed;
var inspect$4 = Ember.inspect;
...
function belongsTo(modelName, options) {
  ...
  (true && !(typeof userEnteredModelName === 'string' || typeof userEnteredModelName === 'undefined') && Ember.assert("The first argument to DS.belongsTo must be a string representing a model type key, not an instance of " + inspect$4(userEnteredModelName) + ". E.g., to define a relation to the Person model, use DS.belongsTo('person')", typeof userEnteredModelName === 'string' || typeof userEnteredModelName === 'undefined'));
...
var computed$6 = Ember.computed;
var inspect$5 = Ember.inspect;
...
function hasMany(type, options) {
  ...
  (true && !(typeof type === 'string' || typeof type === 'undefined') && Ember.assert('The first argument to DS.hasMany must be a string representing a model type key, not an instance of ' + inspect$5(type) + '. E.g., to define a relation to the Comment model, use DS.hasMany(\'comment\')', typeof type === 'string' || typeof type === 'undefined'));
  ...
  return computed$6({
    ...
    set: function set(key, records) {
      ...
      (true && !(function () {
        return A$7(records).every(function (record) {
          return record.hasOwnProperty('_internalModel') === true;
        });
      }()) && Ember.assert('All elements of a hasMany relationship must be instances of DS.Model, you passed ' + inspect$5(records), function () {
        return A$7(records).every(function (record) {
          return record.hasOwnProperty('_internalModel') === true;
        });
      }()));
...
/**
  ...
  @namespace DS
*/
var buildUrlMixin = Mixin.create({
  /**
...
/*
  ...
  @private
*/
var debugAdapter = DataAdapter.extend({
  ...
  observeRecord: function observeRecord(record, recordUpdated) {
    var releaseMethods = A$8();
    var keysToObserve = A$8(['id', 'isNew', 'hasDirtyAttributes']);
