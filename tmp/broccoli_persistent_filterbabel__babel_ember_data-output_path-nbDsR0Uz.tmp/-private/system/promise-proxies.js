...
*/
export var PromiseArray = ArrayProxy.extend(PromiseProxyMixin, {
...
/**
  ...
  @uses Ember.PromiseProxyMixin
*/
export var PromiseObject = ObjectProxy.extend(PromiseProxyMixin);
...
export var PromiseManyArray = PromiseArray.extend({
  reload: function reload() {
    (true && !(get(this, 'content')) && Ember.assert('You are trying to reload an async manyArray before it has been created', get(this, 'content')));
